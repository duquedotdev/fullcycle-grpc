...
type UserServiceClient interface {
	...
	AddUsersBothStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersBothStreamClient, error)
}
...
func (c *userServiceClient) AddUsersBothStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersBothStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/pb.UserService/AddUsersBothStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceAddUsersBothStreamClient{stream}
	return x, nil
}

type UserService_AddUsersBothStreamClient interface {
	Send(*User) error
	Recv() (*UserResultStream, error)
	grpc.ClientStream
}

type userServiceAddUsersBothStreamClient struct {
	grpc.ClientStream
}

func (x *userServiceAddUsersBothStreamClient) Send(m *User) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceAddUsersBothStreamClient) Recv() (*UserResultStream, error) {
	m := new(UserResultStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	AddUsersBothStream(UserService_AddUsersBothStreamServer) error
...
func (UnimplementedUserServiceServer) AddUsersBothStream(UserService_AddUsersBothStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method AddUsersBothStream not implemented")
}
...
func _UserService_AddUsersBothStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).AddUsersBothStream(&userServiceAddUsersBothStreamServer{stream})
}

type UserService_AddUsersBothStreamServer interface {
	Send(*UserResultStream) error
	Recv() (*User, error)
	grpc.ServerStream
}

type userServiceAddUsersBothStreamServer struct {
	grpc.ServerStream
}

func (x *userServiceAddUsersBothStreamServer) Send(m *UserResultStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceAddUsersBothStreamServer) Recv() (*User, error) {
	m := new(User)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AddUsersBothStream",
			Handler:       _UserService_AddUsersBothStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
